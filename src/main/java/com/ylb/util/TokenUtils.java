...
public class TokenUtils {
	...
	public static void main(String[] args) {
		...
		String str = "username_and_password" + new Date().getTime();
		...
		System.out.println("token Result: " + TokenUtils.getToken(str));
		System.out.println("token Result: " + TokenUtils.getToken(str));
		...
		for (int i = 0; i < 1000; i++) {
			...
			System.out.println("checkToken Result: " + checkToken+"/"+i);
