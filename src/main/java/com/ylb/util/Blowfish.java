...
//
//	/**
//	 * destroys (clears) the encryption engine, after that the instance is not valid
//	 * anymore
//	 */
//	public void destroy() {
//		m_bfish.cleanUp();
...
//
//		/**
//		 * encrypts an integer buffer (should be aligned to an two integer border) to
//		 * another int buffer (of the same size or bigger)
//		 * 
//		 * @param inbuffer  buffer with plaintext data
//		 * @param outbuffer buffer to get the ciphertext data
//		 */
...
//
//		/**
//		 * decrypts a byte buffer (should be aligned to an 8 byte border) to another
//		 * byte buffer (of the same size or bigger)
//		 * 
...
//
//		/**
//		 * decrypts an integer buffer (should be aligned to an two integer border) to
//		 * another int buffer (of the same size or bigger)
//		 * 
//		 * @param inbuffer  buffer with ciphertext data
//		 * @param outbuffer buffer to get the plaintext data
...
//
//		/**
//		 * cleans up all critical internals, call this if you don't need an instance
//		 * anymore
//		 */
//		@Override
//		public void cleanUp() {
...
//
//		/**
//		 * encrypts an int buffer (should be aligned to an two integer border) to
//		 * another int buffer (of the same size or bigger)
//		 * 
//		 * @param inbuffer  buffer with plaintext data
//		 * @param outbuffer buffer to get the ciphertext data
...
//		} catch (Exception e) {
//			System.out.println("Blowfish:" + e.getMessage());
//		}
//
