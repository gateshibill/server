...
public class SmsUtil {
	...
	static String testUsername = "chenxiangyou"; //在短信宝注册的用户名
	static String testPassword = "wwzd2016"; //在短信宝注册的密码
	static String httpUrl = "http://api.smsbao.com/sms";
	static String SMS = "【轻呼吸】你的验证码是%s。５分钟内有效。若非本人操作请忽略此消息";
	
	public static void main(String[] args) {

//		String result=sendSms("18565826278","123456");
//		System.out.println("result="+result);
//		if(!"0".equals(result)) {
//			System.out.println("result="+result);
//		}
		
		System.out.println("result=@D".split("@")[0]);
...
//		System.out.println(result);
	...
	public static String sendSms(String phoneNumber, String code) {
		System.out.println(String.format("%s -> %s", phoneNumber, code));
		String testContent = String.format(SMS, code);
