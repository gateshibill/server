...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
    	//获取最新公告
    	$.post('/api/notice/getNewNotice',{},function(data){
    		if(data.code == 0){
    			var content = data.data[0].noticeContent;
    			layer.open({
    	            type: 1,
    	            title: "系统公告",
    	            area: '300px',
    	            ...
    	            btn: ['火速围观'],
    	            moveType: 1,
    	            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">'+content+'</p></pclass></p></div>',
