layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#adminList',
        method:'post',
        url : '/capitalDetail/selectapplyfail',
        cellMinWidth : 95,
        page : true,
        //height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'tradeMoney', title: '交易金额', align:'center',totalRow: true,templet:function (d) {
                    return  !d.tradeMoney?"":"<span style='color:red'>"+d.tradeMoney.toFixed(2)+"</span>"
                }},
            {field: 'source', title: '充值方式', align:'center',sort:true,templet:function (d) {
                    return d.source == "1" ? "银行卡":"支付宝";
                }},
            {field: 'adminName', title: '操作人', align:'center',sort:true,templet:function (d) {
                    return  !d.adminName?"":"<span style='color:red'>"+d.adminName+"</span>"
                }},
            ...
            {field: 'throughReasonFail', title: '拒绝理由', align:'center',templet:function (d) {
                    return  !d.throughReasonFail?"":"<span style='color:red'>"+d.throughReasonFail+"</span>"
                }},
