layui.use(['form','layer','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#adminList',
        method:'post',
        url : '/capitalDetail/selectapplythrough',
        cellMinWidth : 95,
        page : true,
        //height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'adminName', title: '操作人', align:'center',sort:true,templet:function (d) {
                    return "<span style='color:red'>"+d.adminName+"</span>"
                }},
            {field: 'quota', title: '配资比例', align:'center',templet:function (d) {
                    return "<span style='color:red'>"+d.quota+"</span>"
                }},
            {field: 'topMoney', title: '配资金额', align:'center',templet:function (d) {
                    return "<span style='color:red'>"+d.topMoney.toFixed(2)+"</span>"
                }},
