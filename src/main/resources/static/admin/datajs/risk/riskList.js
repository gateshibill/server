layui.use(['form', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        elem: '#adminList',
        method: 'post',
        url: '/memberRiskControl/getrisklist',
        cellMinWidth: 95,
        page: true,
        //height: "full-125",
        limits: [10, 15, 20, 25],
        ...
        cols: [[
            ...
            {title: '操作', minWidth: 50, templet: '#adminListBar', fixed: "right", align: "center"}
        ]]
    });
        ...
        if (layEvent === 'chicang') { //编辑
            var index = layui.layer.open({
                ...
                success: function (layero, index) {
                    setTimeout(function () {
                        layui.layer.tips('点击此处返回风控列表', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
                        });
                    }, 500)
                }
